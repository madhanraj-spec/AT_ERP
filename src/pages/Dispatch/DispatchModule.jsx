    ...
    <div style={{ padding: '2rem', width: '100%', boxSizing: 'border-box' }}>
          ...
          {[1, 2].map((copyNum, cIdx) => (
            <div key={copyNum} style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid #000', paddingBottom: '3mm', marginBottom: '2mm' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <img
                    ...
                    style={{ width: '40px', height: '40px', border: '1px solid #ddd' }}
                  />
                  <span style={{ fontSize: '6px', marginTop: '1px', fontFamily: 'monospace' }}>{printData.slip_number}</span>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '4mm', marginBottom: '2mm', fontSize: '9px' }}>
                <div style={{ border: '1px solid #000', borderRadius: '4px', padding: '2mm' }}>
                  <h4 style={{ margin: '0 0 1mm 0', fontSize: '7.5px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>Consigned To / Vendor</h4>
                  <p style={{ margin: '0 0 1px 0', fontWeight: 'bold', fontSize: '9.5px' }}>{printData.vendor_name}</p>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid #000', borderRadius: '4px', padding: '2mm' }}>
                  <p style={{ margin: 0 }}><strong>Slip Number:</strong> <span style={{ fontFamily: 'monospace', fontWeight: 'bold', fontSize: '10px' }}>{printData.slip_number}</span></p>
      ...
      {printType === 'invoice' && printData && (
        <div className="print-only-container" style={{ display: 'none' }}>
          ...
          <div style={{ padding: '4mm', fontFamily: 'Arial, sans-serif', fontSize: '10px' }}>
            <div style={{ border: '1.5px solid black', borderRadius: '4px', padding: '4mm', minHeight: '276mm', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxSizing: 'border-box' }}>
              <div>
                ...
                {/* Logo & Company info */}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid black', paddingBottom: '3mm', marginBottom: '3mm' }}>
                  <div style={{ display: 'flex', gap: '5mm', alignItems: 'center' }}>
                    <img src="/logo.png" alt="AT Logo" style={{ width: '45px', height: '45px', objectFit: 'contain' }} />
                    <div>
                      <h1 style={{ margin: '0 0 2px 0', fontSize: '18px', fontWeight: '950', letterSpacing: '0.5px' }}>ASHOK TEXTILES</h1>
                      <p style={{ margin: '0 0 2px 0', fontSize: '9px' }}>6/222, SALEM MAIN ROAD, VEERAPANDI, SALEM, TAMIL NADU - 33</p>
                      <p style={{ margin: 0, fontSize: '9px' }}><strong>GSTIN:</strong> 33AAZFA60686D1Z6 | <strong>PAN:</strong> AAZFA6086D</p>
                      <p style={{ margin: 0, fontSize: '9px' }}><strong>Mob:</strong> 9366655050 | <strong>Email:</strong> srini@ashoktextiles.com</p>
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <h2 style={{ margin: 0, fontSize: '14px', fontWeight: '900', letterSpacing: '0.5px' }}>TAX INVOICE</h2>
                    <span style={{ fontSize: '8px', border: '1px solid black', padding: '2px 4px', borderRadius: '2px', display: 'inline-block', marginTop: '2mm', fontWeight: 'bold' }}>ORIGINAL FOR RECIPIENT</span>
                  </div>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '4mm', borderBottom: '1px solid black', paddingBottom: '3mm', marginBottom: '3mm' }}>
                  <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm' }}>
                    <h4 style={{ margin: '0 0 1mm 0', fontSize: '8px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>Details of Receiver (Billed to)</h4>
                    <pre style={{ margin: 0, fontFamily: 'inherit', fontSize: '9.5px', whiteSpace: 'pre-wrap', lineHeight: '1.3' }}>{printData.billed_to_address}</pre>
                  </div>
                  <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm', display: 'flex', flexDirection: 'column', gap: '1px', fontSize: '9px' }}>
                    <div><strong>Invoice No:</strong> <span style={{ fontFamily: 'monospace', fontWeight: 'bold', fontSize: '10px' }}>{printData.bill_number}</span></div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', borderBottom: '1px solid black', paddingBottom: '3mm', marginBottom: '3mm' }}>
                  <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm' }}>
                    <h4 style={{ margin: '0 0 1mm 0', fontSize: '8px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>Details of Consignee (Shipped to)</h4>
                    <pre style={{ margin: 0, fontFamily: 'inherit', fontSize: '9.5px', whiteSpace: 'pre-wrap', lineHeight: '1.3' }}>{printData.shipped_to_address || printData.billed_to_address}</pre>
                  </div>
                </div>

                {/* Main Items Table */}
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', marginBottom: '4mm' }}>
                  <thead>
                      ...
                      return (
                        <tr key={idx} style={{ borderBottom: '1px solid #ccc' }}>
                          ...
                          <td style={{ border: '1px solid black', padding: '2mm 1.5mm', verticalAlign: 'top' }}>
                            ...
                            {item.slips?.length > 0 && (
                              <div style={{ fontSize: '7.5px', color: '#555', marginTop: '1mm', fontFamily: 'monospace', lineHeight: '1.2' }}>
                          ...
                          <td style={{ border: '1px solid black', padding: '2mm 1.5mm', fontSize: '8px', verticalAlign: 'top' }}>
                ...
                {/* Amount in words */}
                <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm', marginBottom: '4mm', fontSize: '9.5px' }}>
              ...
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: '4mm', marginBottom: '4mm' }}>
                  <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm', fontSize: '8.5px' }}>
                  ...
                  <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm', display: 'flex', flexDirection: 'column', gap: '3px', fontSize: '9px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid black', paddingTop: '2px', fontWeight: 'bold', fontSize: '10px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: '4mm' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-end', height: '18mm' }}>
                    <div style={{ fontSize: '8.5px', fontWeight: 'bold' }}>For ASHOK TEXTILES</div>
                    <div style={{ borderTop: '1px dashed #777', width: '35mm', textAlign: 'center', fontSize: '8px', paddingTop: '1mm', color: '#555' }}>Authorised Signatory</div>
                  </div>
                </div>
      ...
      {printType === 'packing_list' && printData && (
        <div className="print-only-container" style={{ display: 'none' }}>
          ...
          <div style={{ padding: '2mm', fontFamily: 'Arial, sans-serif', fontSize: '10px' }}>
            {(printData.items || []).map((item, itemIdx) => {
              ...
              return (
                <div key={itemIdx} className={itemIdx > 0 ? "page-break" : ""} style={{ minHeight: '260mm', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', paddingBottom: '10mm', boxSizing: 'border-box' }}>
                  <div>
                    {/* Header */}
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1.5px solid black', paddingBottom: '3mm', marginBottom: '4mm' }}>
                      <div style={{ display: 'flex', gap: '6mm', alignItems: 'center' }}>
                        <img src="/logo.png" alt="AT Logo" style={{ width: '45px', height: '45px', objectFit: 'contain' }} />
                        <div>
                          <h1 style={{ margin: '0 0 2px 0', fontSize: '16px', fontWeight: '950', letterSpacing: '0.5px' }}>ASHOK TEXTILES</h1>
                          <p style={{ margin: '0 0 2px 0', fontSize: '9px' }}>6/222, SALEM MAIN ROAD, VEERAPANDI, SALEM, TAMIL NADU - 33</p>
                          <p style={{ margin: 0, fontSize: '9px' }}><strong>GSTIN:</strong> 33AAZFA60686D1Z6</p>
                        </div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        <h2 style={{ margin: 0, fontSize: '14px', fontWeight: '900', color: '#800000', letterSpacing: '0.5px' }}>DETAILED PACKING LIST</h2>
                    ...
                    {/* Address boxes */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '4mm', marginBottom: '4mm', fontSize: '9px' }}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '2mm' }}>
                        <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm' }}>
                          <h4 style={{ margin: '0 0 1mm 0', fontSize: '8px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>FROM</h4>
                        ...
                        <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm' }}>
                          <h4 style={{ margin: '0 0 1mm 0', fontSize: '8px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>APPLICANT (BILLED TO)</h4>
                          <pre style={{ margin: 0, fontFamily: 'inherit', whiteSpace: 'pre-wrap', lineHeight: '1.2' }}>{printData.billed_to_address}</pre>
                        </div>
                        <div style={{ border: '1px solid black', borderRadius: '4px', padding: '2mm' }}>
                          <h4 style={{ margin: '0 0 1mm 0', fontSize: '8px', textTransform: 'uppercase', color: '#555', fontWeight: 'bold' }}>FABRIC DESPATCH TO (SHIPPED TO)</h4>
                    ...
                    {/* Fabrics declaration */}
                    <div style={{ background: '#f5f5f5', border: '1px solid black', borderRadius: '4px', padding: '1.5mm 2mm', marginBottom: '4mm', fontSize: '9px', fontWeight: 'bold', textAlign: 'center' }}>
                      100% COTTON YARN DYED WOVEN FABRICS
                    </div>

                    {/* Slips subtable */}
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9.5px', marginBottom: '4mm' }}>
                      <thead>
                        <tr style={{ background: '#f5f5f5', borderTop: '1px solid black', borderBottom: '1px solid black' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid black', paddingTop: '4mm' }}>
                    ...
                    <div style={{ textAlign: 'right', fontSize: '9px' }}>
                      ...
                      <br /><br />
                      <span style={{ fontSize: '8px', color: '#555' }}>Authorised Signatory</span>
                    </div>
                  </div>
                </div>
              );
